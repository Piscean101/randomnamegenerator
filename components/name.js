...
export const boyName = [ 
    ...
    'Farzin','Felix','Fernando','Finn','Finnegan','Fletcher','Flint','Floyd','Fofo','Francis','Francisco','Frank','Frankie','Franz','Fred','Frederick','Fry',
    ...
    'Kai','Kafil','Kalen','Kaluna','Kash','Kane','Kanye','Karim','Keanu','Keenan','Keion','Keith','Ken','Kenji','Kennedy','Kenny','Kenshi','Kevin','Khalid','Khrishna','Kia','Kiefer','Kiff','Kim','Kingsley','Kingston','Kirk','Kit','Kobe','Konstantin','Korir','Kot','Kovu','Kyle','Kyrie',
    'Laith','Lamelo','Lance','Larry','Latif','Lawrence','Lee','Leo','Leonard','Leroy','Liam','Lincoln','Lionel','Loas','Logan','Lonzo','Louis','Lucas','Lucian','Luther','Lyle','Lyric',
    ...
    'Sadam','Salim','Sam','Samuel','Saul','Savros','Sawyer','Scott','Seal','Seamus','Sean','Sergei','Sergio','Seth','Shabba','Shane','Shaquille','Shan','Shane','Shaun','Sheen','Sheldon','Shere','Shiloh','Shohel','Sid','Silas','Simon','Sina','Skylar','Snoop','Sokka','Solomon','Sonny','Spencer','Stefan','Stephen','Sterling','Steve','Steven','Stevenson','Stewie','Stuart','Sullivan','Sylvester',
    'Tahjay','Tai','Tanner','Tate','Tenzen','Teo','Theo','Theodore','Thomas','Timon','Timothy','Tio','Todd','Todrick','Tom','Tony','Travis','Trent','Trevor','Trevon','Trey','Trip','Tristan','Troy','Truce','Tucker','Tunde','Tyler','Tyre','Tyrell','Tyrone','Tyson',
    'Ulisses',
    'Valentine','Vance','Varney','Vernon','Victor','Vincent','Vishesh','Vox',
    'Walter','Warren','Wayne','Welcome','Wesley','Weston','Wilbur','Wiley','Will','William','Willy','Wilson','Winston','Wolfe','Wolfgang','Woodrow','Woody','Wyatt',
    'Xavier','Xerxes',
...
export const girlName = [
    ...
    'Babs','Barbara','Bailey','Beatrice','Bebe','Belcalis','Bella','Belladonna','Bernice','Bertha','Bertrand','Beth','Bia','Bianca','Billie','Blair','Blanca','Blanche','Blessing','Blondie','Blythe','Boa','Bonnie','Brandy','Brenda','Briana','Briel','Bridgette','Brina','Britney','Brooke','Brooklyn',
    'Cady','Caitlyn','Calm','Camilla','Candice','Carly','Carmen','Carmilla','Carol','Caroline','Carla','Carrie','Cat','Cate','Cathleen','Caitlyn','Cecilia','Celia','Celie','Celine','Cerebullum','Cersei','Charian','Charlie','Charlotte','Chastity','Chelsea','Chian','Chichi','Chrisean','Chrissy','Christina','Christine','Ciele','Colby','Colette','Coraline','Cordelia','Corona','Cortana','Courtney','Celie','Celine','Chaka','Chanel','Channing','Cherry','Cheryl','Chloe','Christina','Christine','Cindy','Claire','Clarissa','Clear','Clementine','Cleo','Cleopatra','Cocoa','Colette','Colleen','Connie','Constance','Cordelia','Corinth','Corrine','Cynthia',
    ...
    'Illinois','Iman','Imani','Imogen','India','Indiana','Iracebeth','Irene','Iris','Isabella','Isabelle','Isla','Ivanka','Ivy','Iyana',
    'Jacqueline','Jade','Jamie','Jan','Janae','Jane','Janet','Janice','Janine','Jaida','Jasmine','Jean','Jeanette','Jennifer','Jessica','Jessie','Jewel','Jillian','Joan','Joanna','Johansson','Jojo','Jolene','Jonbers','Josephine','Joslyn','Journey','Jude','Judith','Julia','Juliette','June','Juniper','Juno','Justine',
    'Kahanna','Kaley','Kamala','Karen','Karuna','Kat','Katara','Kate','Kathleen','Kathy','Katie','Katrina','Katya','Kaya','Kaylee','Kedijah','Keep','Keisha','Keke','Kelly','Kelsey','Kemi','Kendall','Kennedy','Kenya','Kerry','Kerry-Ann','Khia','Kiley','Kim','Kimberly','Kimmie','Kitty','Konnika','Korra','Kris','Kristen','Kylie',
    'Lady','Lana','Latrice','Laura','Lauren','Lawrence','Layla','Leah','Leanne','Leeza','Lena','Lenore','Leona','Leonie','Leslie','Libby','Liese','Lila','Lily','Linda','Lisa','Llorona','Lois','Loni','Loretta','Lori','Lottie','Lou Anne','Loyalty','Lucille','Lucy','Luisa','Lulu','Luna','Lurlene','Lydia','Lynn',
    ...
    'Nadine','Nadira','Naela','Naija','Nairah','Nairobi','Nan','Nancy','Naomi','Natalia','Natalie','Natasha','Naturia','Naya','Naysha','Naz','Nedra','Neera','Nella','Nelly','Nicki','Nicole','Nina','North','Nyongbella',
    'Octavia','Ofra','Olandria','Olga','Olive','Olivia','Omarosa','Onijah','Onika',
    'Pacifica','Paige','Pamela','Pan','Paris','Patrice','Patricia','Patsy','Patti','Pauline','Peach','Penelope','Pepper','Phelps','Phillis','Phoebe','Pi','Polly','Prayer','Precious','Princess','Priscilla','Priya','Promise','Prudence','Purity',
    'Queen','Queenie','Quinn',
    ...
    'Talin','Tameka','Tamera','Tanjie','Tanya','Taraji','Tarisai','Tasha','Tatianna','Taylor','Temple','Terri','Tessa','Teyana','Tia','Tiana','Tiffany','Tina','Toni','Tori','Tosan','Tova','Tracy','Trina','Trinity','Trisha','Trixie','Trudy','Truth','Tulip','Tyra',
    'Unity','Ursa','Ursula','Ulba',
    'Vagie','Valerie','Vanessa','Vanity','Vee','Venus','Veruca','Vicky','Victoria','Victory','Vivian','Volha',
...
export const lastName = [
    'Abraham','Abrams','Adair','Adamol','Addams','Adewusi','Adler','Afualo','Agnon','Agusto','Albani','Allegro','Allen','Ali','Almanzar','Alvarez','Amkpa','Amuli','Anderson','Andros','Angelou','Annuli','Antwi','Apple','Aren','Armstrong','Asai','Ashford','Aubertin','Avery','Ayodele','Ayoub',
    ...
    'Padalecki','Page','Palmer','Pandit','Parekh','Parikh','Parker','Parris','Parton','Pastor','Patel','Patterson','Paulson','Pelosi','Pete','Peters','Peterson','Pharoah','Phillips','Phillis','Pickett','Pierce','Pierre','Piers','Pierson','Pilot','Pirate','Popescu','Powers','Preacher','Prescott','Presley','Preston','Private','Pryor',
    ...
    'Tailor','Takahashi','Tanner','Tanuvasa','Tarraban','Tate','Tatum','Taylor','Teigen','Tennessee','Thatcher','Theodore','Theriault','Thomas','Thompson','Thorne','Three','Thrombey','Tiller','Tilling','Timberland','Tisdale','Toledo','Tolke','Tolur','Torres','Tran','Trooper','Trump','Trusket','Tubman','Turner','Tyson',
    'Uqwu','Urban','Uyger','Uzman',
    'Vandross','Vasili','Vaughan','Velour','Virgin','Voellinger','Von Eschen', 'Von Feldt','Vox',
