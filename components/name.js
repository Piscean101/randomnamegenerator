...
export const girlName = [
    ...
    'Saadia','Sabrina','Sadie','Salem','Sally','Sam','Samantha','Sandy','Sapphire','Sarabi','Sarah','Sasha','Savannah','Savleen','Scarlett','Selena','Serena','Serenity','Shanice','Shannel','Shannon','Shanti','Sharia','Sharon','Sharsha','Shauna','Shea','Sheila','Shelly','Sherry','Shirley','Sidibe','Sienna','Silkie','Simone','Sky','Sloan','Sminty','Sohana','Sonny','Sonya','Sophia','Spankie','Splenda','Sriracha','Stacy','Stallone','Star','Stella','Stephanie','Stevie','Striga','Sue','Sumaya','Summer','Sugar','Suji','Suki','Susan','Suzanne','Sweetie','Sybil','Sydney','Sylvia','Sypha',
