...
export const boyName = [ 
    ...
    'Easton','Ebi','Edgar','Edward','Eli','Elial','Elias','Elijah','Elliot','Ellis','Ellison','Elon','Elson','Emerson','Emilio','Emmanuel','Emmet','Emory','Enrique','Eric','Esteban','Ethan','Etienne','Eugene','Eustace','Evan','Ezekiel',
    ...
    'Ralph','Rama','Ramon','Ramses','Randall','Randy','Rashad','Ray','Raymond','Raymonte','Reed','Reese','Reginald','Remmick','Renard','Richard','Richter','Rick','Rico','Rickey','Riley','Rio','Robert','Robin','Rocky','Roderick','Rodney','Rodolfo','Rodrigo','Roger','Roman','Ron','Ronald','Roozbeh','Ross','Roy','Rudolph','Russell','Ryan',
    ...
    'Xavier','Xerxes',
    'Yanis','Yevgeny','Yuri',
    'Zachary','Zaid','Zap','Zayn','Zeke','Zion','Zippy','Zoran','Zuko'
]
