...
export const girlName = [
    'Abigail','Adele','Adriana','Aibileen','Aisan','Aisha','Alba','Alex','Alexandra','Alexis','Alice','Alicia','Alize','Allegra','Allison','Allura','Alyssa','Amala','Amanda','Amani','Amy','Ana','Anabelle','Anastasia','Anetra','Angel','Angela','Angelina','Aniston','Anna','Anna Mae','Annie','Apple','April','Ariel','Asami','Ashley','Aubergine','Aubrey','Audrey','August','Augustine','Aurora','Ava','Avacyn','Avery','Aziza','Azula',
    ...
    'Cady','Caitlyn','Calm','Camilla','Candice','Carly','Carmen','Carmilla','Carol','Caroline','Carla','Carrie','Cat','Caitlyn','Cecilia','Celia','Celie','Celine','Cerebullum','Charian','Charlie','Charlotte','Chastity','Chian','Chichi','Christina','Christine','Ciele','Colby','Colette','Coraline','Cordelia','Cortana','Celie','Celine','Chaka','Chanel','Channing','Cherry','Cheryl','Chloe','Christina','Christine','Cindy','Claire','Clarissa','Clear','Clementine','Cocoa','Colleen','Connie','Constance','Cordelia','Corinth','Corrine',
    'Dahlia','Dakota','Danica','Daphne','Danielle','Darienne','Darling','Dawn','Deborah','Deena','Deja','Delilah','Delinda','Delores','Delphine','Destiny','Diamond','Diana','Diane','Dijonay','Dita','Dixie','Doja','Dolly','Dominique','Donna','Dorothy','Drew',
    'Ebony','Eileen','Elizabeth','Ellen','Ellie','Eloise','Elsa','Emily','Emma','Erica','Erin','Erzabet','Esther','Eugenia','Eve','Evelyn',
    'Faith','Fannita','Fanny','Fantasia','Farrah','Fayette','Felicia','Fiona','Francis','Freida',
    'Gabriella','Gabourey','Gaia','Gail','Ganyo','Gemma','Genesis','Genie','Georgia','Geraldine','Germaine','Gertrude','Gia','Gianni','Gift','Gina','Ginger','Gloria','Grace','Greta','Gretchen','Gwen',
    'Haley','Haliya','Halsey','Hannah','Happy','Harper','Harriet','Hattie','Hayden','Heather','Heidi','Helen','Henrietta','Hermoine','Hillary','Hilly','Honey','Hope',
    'Illinois','India','Indiana','Irene','Isabella','Isabelle','Isla','Iman','Ivanka','Ivy','Iyana',
    'Jacqueline','Jade','Jamie','Jan','Janae','Jane','Janet','Janice','Janine','Jaida','Jasmine','Jean','Jeanette','Jennifer','Jessica','Jessie','Jewel','Jillian','Joan','Joanna','Johansson','Jojo','Jolene','Jonbers','Josephine','Joslyn','Jude','Judith','Julia','Juliette','June','Juniper','Juno',
    ...
    'Lana','Latrice','Laura','Lauren','Lawrence','Layla','Leah','Leanne','Leeza','Lena','Lenore','Leona','Leonie','Leslie','Liese','Lily','Lisa','Lois','Loni','Lori','Lottie','Loyalty','Lucille','Lucy','Luisa','Lurlene','Lydia','Lynn',
    'Mackenzie','Macy','Madea','Madeline','Madison','Maggie','Mallory','Mandy','Marcia','Margaret','Maria','Mariah','Marilyn','Marina','Marissa','Marjorie','Marny','Mary','Masha','Malaysia','Matilda','Maury','Maven','Mavis','Mawish','Maxine','May','Maya','Megan','Meka','Melania','Melanie','Melinda','Melody','Mercedes','Mercies','Mia','Michaela','Milan','Miley','Millie','Minnie','Mirabel','Miranda','Missy','Misty','Moana','Moesha','Moira','Molly','Mona','Monae','Monica','Morana','Morgan','Mori','Mulan','Muriel','Musk','Myrna','Myrtle',
    'Nadine','Nadira','Naija','Nairah','Nairobi','Nan','Nancy','Naomi','Natalia','Natalie','Naturia','Naya','Naysha','Naz','Nedra','Neera','Nelly','Nicki','Nicole','Nina','North','Nyongbella',
    ...
    'Queen','Queenie','Quinn',
    'Rachel','Rainette','Ramona','Raquel','Raven','Rayvonne','Rebecca','Rebel','Red','Redarys','Regina','Remy','Renee','Resha','Riley','Rita','Rochelle','Rosa','Rosalie','Rose','Roseline','Rosetta','Roshane','Roslyn','Ruth',
    'Saadia','Sabrina','Sadie','Salem','Sally','Sam','Samantha','Sapphire','Sarabi','Sarah','Sasha','Savannah','Savleen','Scarlett','Selena','Serena','Serenity','Shanice','Shannel','Shannon','Shanti','Sharia','Sharon','Shauna','Shea','Sheila','Shelly','Sherry','Shirley','Sidibe','Sienna','Silkie','Simone','Sky','Sloan','Sminty','Sonny','Sonya','Sophia','Spankie','Splenda','Sriracha','Stacy','Stallone','Star','Stella','Stevie','Striga','Sue','Sumaya','Summer','Sugar','Suji','Suki','Susan','Suzanne','Sweetie','Sybil','Sydney','Sylvia','Sypha',
    'Talin','Tameka','Tamera','Tanya','Taraji','Tarisai','Tasha','Tatianna','Taylor','Terri','Tessa','Tia','Tiana','Tiffany','Tina','Toni','Tori','Tova','Tracy','Trina','Trinity','Trisha','Trixie','Trudy','Truth','Tulip','Tyra',
...
export const lastName = [
    ...
    'Baga','Bailey','Baker','Ball','Ballo','Barbarelli','Barlowe','Barrett','Baskin','Bassett','Bastion','Bates','Baxter','Beach','Beacon','Beard','Becker','Beckingham','Bell','Bellamy','Belli','Belmont','Belnades','Belsky','Bennett','Benson','Berfield','Bernard','Berry','Bertz','Besselman','Bettany','Bhandari','Bickler','Bidinger','Biles','Birch','Bixby','Blacksmith','Blackson','Blanche','Blonde','Boelter','Brannigan','Braxton','Bonet','Boston','Boule','Boyle','Bravo','Briar','Bronson','Brooks','Brown','Burton','Buttigieg',
    'Cabello','Cadelle','Cambridge','Capwell','Carey','Carnegie','Carney','Carothers','Carrington','Carter','Caville','Chalobi','Chamberlain','Chambers','Chanel','Chaney','Chapman','Chatman','Chow','Chrysler','Clarke','Coates','Coin','Colby','Coleman','Colombus','Comey','Cook','Coolidge','Cooper','Colombus','Colt','Conley','Conroy','Cordes','Cordova','Cortez','Cortova','Cosgrove','Coulee','Courtright','Cowell','Craig','Crest','Crocker','Crockett','Cruise','Cruz','Cullen','Cyrus',
    ...
    'Gaines','Gale','Garrison','Gates','Gaynor','George','Gestor','Gibson','Gigant','Gillies','Glover','Goldman','Gomez','Gonzales','Goode','Goose','Gosling','Goyer','Granger','Graves','Greene','Greenwich','Greer','Griffin','Gross','Grouper','Gunn',
    'Hall','Hanoman','Harris','Hartman','Harvey','Hayes','Heart','Hefferman','Heiffenwood','Hernandez','Henson','Higashi','Higgins','Hill','Hitchens','Hobbs','Hoffman','Hogan','Holcombe','Hopkins','Horton','Hortua','Hossein','Houston','Howard','Howell','Hubbard','Hudson','Huxley','Huxtable','Huxton',
    ...
    'Lake','Lamothe','Landry','Lane','Langdon','Lange','Lawson','Lenin','Laporte','Lavender','Lepore','Levine','Lewinsky','Lewis','Liason','Lincoln','Lipton','Liu','Lockley','Lofton','Lombardo','Long','Looker','Lopez','Lourd','Love',
    'MacIntosh','Mackenzie','Madolf','Mahmoud','Mammen','Maraj','Markov','Mars','Marsh','Maters','Mathai','Malik','Mandrake','Mantle','Marquez','Masters','Mateo','Mattel','Maury','Maxwell','Mayers','Mayweather','McAdams','McCurdy','McDonald','McIntyre','Messi','Meyers','Michaels','Milan','Miller','Milton','Minifie','Minogue','Mitsubishi','Monroe','Montana','Monterey','Moore','Morales','Morgan','Morris','Morton','Mosby','Montgomery','Muktar','Mullings','Muniz','Murphy','Musitz','Musso','Mustafa',
    ...
    'Page','Palmer','Pandit','Parekh','Parikh','Parker','Parris','Parton','Pastor','Patel','Patterson','Paulson','Pelosi','Pete','Peters','Peterson','Phillips','Phillis','Pickett','Pierce','Pierre','Piers','Pilot','Popescu','Powers','Preacher','Presley','Preston','Pryor',
    'Quan','Qul','Qureshi',
    ...
    'Saaed','Salam','Saleem','Salvador','Samsung','Sandalis','Sandler','Santos','Satori','Savant','Sawyer','Scone','Seeker','Segal','Senatra','Several','Shaw','Shepherd','Shepley','Shinobi','Shore','Short','Sidibe','Simmons','Sinclair','Singer','Singh','Smith','Snipes','Sivan','Solanas','Solas','Solomon','Song','Sordid','Sosa','Speaker','Star','Stark','State','Stentor','Stevens','Stint','Stone','Stough','Streicher','Striker','Struthers','Styles','Summers','Sue','Suresh','Sutherland','Sutra','Sutton','Switcher','Swiss','Sylvester',
    'Tailor','Takahashi','Tanner','Tanuvasa','Tarraban','Tate','Tatum','Taylor','Tennessee','Thatcher','Theodore','Theriault','Thomas','Thompson','Three','Thrombey','Tiller','Tilling','Timberland','Tisdale','Toledo','Tolke','Tolur','Torres','Tran','Trooper','Trusket','Tubman','Turner','Tyson',
